...
## UI Design Specification Rule
**ALWAYS read and strictly adhere to [design.md](file:///Users/navnitrai/job/second_openion/design.md) (or `desgine.md`) whenever coding UI, building screens, creating components, or styling visual elements.**
All colors, typography tokens, spacing, component structures, border radii, shadows, and layout guidelines defined in `design.md` must be followed across all UI work.
