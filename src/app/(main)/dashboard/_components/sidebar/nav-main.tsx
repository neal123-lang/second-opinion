  ...
  return (
    <SidebarMenuItem>
      <SidebarMenuButton
        ...
        isActive={isActive}
        className={cn(
          "relative h-10 rounded-full px-3 text-sm transition-colors text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0",
          isActive &&
            "bg-sidebar-accent font-semibold text-sidebar-accent-foreground before:absolute before:left-1 before:top-2.5 before:bottom-2.5 before:w-1 before:rounded-full before:bg-primary group-data-[collapsible=icon]:before:hidden",
        )}
      >
        <Link
          prefetch={false}
